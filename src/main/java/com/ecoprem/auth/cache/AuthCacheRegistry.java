package com.ecoprem.auth.cache;
...
/**
 * Registro centralizado de caches utilizados no módulo de autenticação do EcoPrem ERP.
 *
 ...
 * <ul>
 *   <li>{@link com.ecoprem.auth.service.LoginAttemptService}</li>
 *   <li>{@link com.ecoprem.auth.service.TwoFactorAuthService}</li>
 *   <li>{@link com.ecoprem.auth.service.RateLimiterService}</li>
 * </ul>
 *
